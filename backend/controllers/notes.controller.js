...
exports.getAllNotes = async (user, req, res, next) =>
{
    ...
    catch (error)
    {
        ...
        ({
            code : 500,
            status : false,
            message : "Internal Server Error while fetching all the notes"
        });        
    }
};
...
exports.AddNewNote = async (userId, req, res, next) =>
{
    ...
    catch (error)
    {
        ...
        ({
            code : 500,
            status : false,
            message :"Internal Server Error While Adding New Note"
        });   
    }
};
...
{  
    ...
    catch (error)
    {
        ...
        ({
            code : 500,
            status : false,
            message :"Internal Server Error While Updating The Existing Note"
        });   
    }
};
